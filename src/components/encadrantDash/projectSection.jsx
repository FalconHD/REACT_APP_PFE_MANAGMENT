      ...
      <div className="projects-section-line">
        ...
        <div className="view-actions">
          ...
          <button className="view-btn grid-view active" title="Grid View" onClick={() => { setOpenPopup(true); }}>
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/1999/xlink" x="0px" y="0px"
              viewBox="0 0 443.733 443.733" style={{ "enable-background": "new 0 0 443.733 443.733" }} xml="preserve">
              <g>
                <g>
