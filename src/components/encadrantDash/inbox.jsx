      ...
      <div className="mail-detail">
       ...
       <div className="mail-contents">
        <div className="mail-contents-subject">
         ...
         <div className="mail-contents-title">Write an article about design</div>
        </div>
        <div className="mail">
         ...
         <div className="mail-checklist">
          ...
          <div className="mail-checklist-date">19 May, 2020</div>
         </div>
